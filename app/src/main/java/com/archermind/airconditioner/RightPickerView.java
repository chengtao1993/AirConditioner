...
public class RightPickerView extends ScrollView {
    ...
    public RightPickerView(Context context) {
        this(context, null);
    }

    public RightPickerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RightPickerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setPosition(int position) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                Log.d("hct","289position = "+RightPickerView.this.position * mTextHeight);
                smoothScrollTo(0, RightPickerView.this.position * mTextHeight);
            }
        });
    }
